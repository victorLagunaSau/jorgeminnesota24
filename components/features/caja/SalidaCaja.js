...
import OperacionSalida from './OperacionSalida';  // Asegúrate de que el nombre del archivo sea correcto
...
const SalidaVehiculo = ({ user }) => {
    ...
    return (
        <div id="area-trabajo" className="max-w-3xl mx-auto mt-6">
            ...
            {/* Aquí llamamos al componente OperacionSalida */}
            <OperacionSalida user={user} />
        </div>
    );
};
