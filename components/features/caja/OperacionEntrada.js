...
const OperacionEntrada = ({ user }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await firestore().collection(COLLECTIONS.MOVIMIENTOS).add({
                ...
                entradaCajaTipo: tipoPago,
                entradaCajaMotivoPago: motivoPago,
                entradaCajaReceptor: nombreReceptor,
                entradaCajaConceptoPago: conceptoPago,
                cajaCC: 0
            });
    ...
    return (
        <div className="w-full max-w-3xl mx-auto mt-2">
            ...
            <div className="mb-4">
                <label className="block text-gray-700">Tipo de Entrada</label>
                <select
                    value={tipoPago}
                ...
                >
                    ...
                    <option value="ECI">Capital Inicial</option>
                    <option value="ERC">Recibo Capital</option>
                    <option value="EP">Pago</option>
                </select>
            </div>

            <div className="mb-4">
                <label className="block text-gray-700">Nombre de quien entrega</label>
                <input
                    type="text"
            ...
            <div className="mb-4">
                <label className="block text-gray-700">Motivo (Opcional)</label>
                <textarea
                    value={motivoPago}
            ...
            >
                {loading ? 'Procesando...' : 'Realizar Entrada'}
            </button>
